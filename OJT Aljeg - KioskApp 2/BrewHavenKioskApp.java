...
// Placeholder for TableSelectionPanel
...
public class BrewHavenKioskApp {
    ...
    // Add this as a class variable in your BrewHavenKioskApp class
    ...
    private JPanel createTableSelectionScreen() {
        ...
        instructionsLabel.setFont(SUBTITLE_FONT);
        instructionsLabel.setForeground(BH_DARK_RED);
        ...
        continueButton.setBackground(BH_GREEN);
    ...
    private BufferedImage createPlaceholderImageForSaving(int width, int height, String itemName, String category) {
        ...
        // Use BH_LIGHT_RED color for a border
        g.setColor(BH_LIGHT_RED);
...
imagePanel.setPreferredSize(new Dimension(80, 80));
    ...
    private JPanel createCheckoutScreen() {
        ...
        if ("Dine In".equals(orderType) && selectedTable != -1) {
            ...
            tableInfoPanel.setBackground(BH_WHITE);

            JLabel tableLabel = new JLabel("Table: " + selectedTable);
            tableLabel.setFont(BODY_FONT);
            tableLabel.setForeground(BH_DARK_RED);
        ...
        double finalTotal = total; // Make total effectively final
    ...
    private JPanel createOrderConfirmationScreen() {
        ...
        if ("Dine In".equals(orderType) && selectedTable != -1) {
            ...
            tableNumberLabel.setFont(HEADING_FONT);
            tableNumberLabel.setForeground(BH_DARK_GRAY);
